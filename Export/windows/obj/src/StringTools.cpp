...
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_50_urlEncode,"StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","D:\\Hackse\\haxe\\std/StringTools.hx",50,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_118_urlDecode,"StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","D:\\Hackse\\haxe\\std/StringTools.hx",118,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_158_htmlEscape,"StringTools","htmlEscape",0x0e1a5dd0,"StringTools.htmlEscape","D:\\Hackse\\haxe\\std/StringTools.hx",158,0x8a159353)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_194_htmlUnescape,"StringTools","htmlUnescape",0x7457fea9,"StringTools.htmlUnescape","D:\\Hackse\\haxe\\std/StringTools.hx",194,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_240_startsWith,"StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","D:\\Hackse\\haxe\\std/StringTools.hx",240,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_251_endsWith,"StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","D:\\Hackse\\haxe\\std/StringTools.hx",251,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_282_isSpace,"StringTools","isSpace",0xe0290778,"StringTools.isSpace","D:\\Hackse\\haxe\\std/StringTools.hx",282,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_300_ltrim,"StringTools","ltrim",0x24d2234a,"StringTools.ltrim","D:\\Hackse\\haxe\\std/StringTools.hx",300,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_325_rtrim,"StringTools","rtrim",0x99399e50,"StringTools.rtrim","D:\\Hackse\\haxe\\std/StringTools.hx",325,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_353_trim,"StringTools","trim",0x2908d066,"StringTools.trim","D:\\Hackse\\haxe\\std/StringTools.hx",353,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_369_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","D:\\Hackse\\haxe\\std/StringTools.hx",369,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_428_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","D:\\Hackse\\haxe\\std/StringTools.hx",428,0x8a159353)
HX_LOCAL_STACK_FRAME(_hx_pos_ec915fefa3b6e4c0_438_hex,"StringTools","hex",0xd91debd7,"StringTools.hex","D:\\Hackse\\haxe\\std/StringTools.hx",438,0x8a159353)
...
::String StringTools_obj::urlEncode(::String s){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_50_urlEncode)
...
::String StringTools_obj::urlDecode(::String s){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_118_urlDecode)
...
::String StringTools_obj::htmlEscape(::String s, ::Dynamic quotes){
            	HX_GC_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_158_htmlEscape)
...
::String StringTools_obj::htmlUnescape(::String s){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_194_htmlUnescape)
...
bool StringTools_obj::startsWith(::String s,::String start){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_240_startsWith)
...
bool StringTools_obj::endsWith(::String s,::String end){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_251_endsWith)
...
bool StringTools_obj::isSpace(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_282_isSpace)
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_300_ltrim)
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_325_rtrim)
...
::String StringTools_obj::trim(::String s){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_353_trim)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_GC_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_369_lpad)
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_428_replace)
...
::String StringTools_obj::hex(int n, ::Dynamic digits){
            	HX_STACKFRAME(&_hx_pos_ec915fefa3b6e4c0_438_hex)
