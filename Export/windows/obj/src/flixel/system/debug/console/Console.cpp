...
HXLINE( 265)				::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,output),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            			}
...
HXDLIN( 280)					_this->advanced(data,_this->styles->error,true,::hx::SourceInfo(HX_("flixel/system/debug/console/Console.hx",c8,43,79,36),280,HX_("flixel.system.debug.console.Console",98,1f,eb,2e),HX_("processCommand",9c,b2,cb,33)));
            				}
            			}
            			else {
