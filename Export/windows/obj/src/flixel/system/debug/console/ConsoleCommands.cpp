...
HXDLIN( 103)					_this->advanced(((HX_("Help: The command '",5c,dd,57,6e) + Alias) + HX_("' does not have help text.",1f,16,65,26)),_this->styles->error,true,::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleCommands.hx",e0,f1,0d,8e),103,HX_("flixel.system.debug.console.ConsoleCommands",80,e4,ff,a4),HX_("help",c1,32,0b,45)));
            				}
...
HXDLIN( 133)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,(((text + obj->x) + HX_(" Y = ",ca,0a,bf,a7)) + obj->y)),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            		}
            		else {
...
HXDLIN( 135)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,text3),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            		}
...
HXDLIN( 142)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,text4),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            		}
            	}
...
HXDLIN( 152)		::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,text),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            	}
...
HXDLIN( 157)		::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,text),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            	}
...
HXLINE( 165)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("watchMouse: Mouse position added to watch window",86,9c,f8,24)),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            		}
            		else {
HXLINE( 169)			{
...
HXLINE( 170)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("watchMouse: Mouse position removed from watch window",17,fe,23,1d)),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            		}
...
HXLINE( 181)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("pause: Game unpaused",f9,e8,d5,eb)),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            		}
            		else {
HXLINE( 185)			::flixel::FlxG_obj::vcr->pause();
HXLINE( 186)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("pause: Game paused",60,a9,dd,91)),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            		}
            	}
