...
HXDLIN(  36)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(  36)			rect->_inPool = false;
HXDLIN(  36)			rect->_weak = false;
HXDLIN(  36)			 ::flixel::math::FlxRect _this = rect;
HXDLIN(  36)			_this->x = x;
HXDLIN(  36)			_this->y = y;
HXDLIN(  36)			_this->width = ( (Float)(1) );
HXDLIN(  36)			_this->height = ( (Float)(1) );
HXDLIN(  36)			 ::flixel::math::FlxRect rect1 = _this;
