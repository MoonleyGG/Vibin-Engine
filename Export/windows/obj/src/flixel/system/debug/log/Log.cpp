...
HX_LOCAL_STACK_FRAME(_hx_pos_9fa3e0ab86ae8b4a_110_clear,"flixel.system.debug.log.Log","clear",0xc2400811,"flixel.system.debug.log.Log.clear","flixel/system/debug/log/Log.hx",110,0x223ade2e)
HX_LOCAL_STACK_FRAME(_hx_pos_9fa3e0ab86ae8b4a_122_updateSize,"flixel.system.debug.log.Log","updateSize",0x7fdfd666,"flixel.system.debug.log.Log.updateSize","flixel/system/debug/log/Log.hx",122,0x223ade2e)
...
bool Log_obj::add(::cpp::VirtualArray data, ::flixel::_hx_system::debug::log::FlxLogStyle style,::hx::Null< bool >  __o_fireOnce){
...
HXLINE(  68)		::String text = style->toLogString(data);
HXDLIN(  68)		int style1 = style->format->size;
HXDLIN(  68)		::String text1 = style->format->getColorString(null());
HXDLIN(  68)		::String text2 = ::flixel::util::FlxStringUtil_obj::htmlFormat(text,style1,text1,style->format->bold,style->format->italic,style->format->underlined);
HXLINE(  71)		if (fireOnce) {
HXLINE(  73)			int _g = 0;
HXDLIN(  73)			::Array< ::String > _g1 = this->_lines;
HXDLIN(  73)			while((_g < _g1->length)){
HXLINE(  73)				::String line = _g1->__get(_g);
HXDLIN(  73)				_g = (_g + 1);
HXLINE(  75)				if ((text2 == line)) {
HXLINE(  77)					return false;
            				}
            			}
            		}
HXLINE(  83)		if ((this->_lines->length <= 0)) {
HXLINE(  85)			this->_text->set_text(HX_("",00,00,00,00));
            		}
HXLINE(  88)		this->_lines->push(text2);
HXLINE(  90)		if ((this->_lines->length > 200)) {
HXLINE(  92)			this->_lines->shift();
HXLINE(  93)			::String newText = HX_("",00,00,00,00);
HXLINE(  94)			{
HXLINE(  94)				int _g2 = 0;
HXDLIN(  94)				int _g3 = this->_lines->length;
HXDLIN(  94)				while((_g2 < _g3)){
HXLINE(  94)					_g2 = (_g2 + 1);
HXDLIN(  94)					int i = (_g2 - 1);
HXLINE(  96)					newText = (newText + (this->_lines->__get(i) + HX_("<br>",b2,8d,f3,27)));
            				}
            			}
HXLINE(  98)			this->_text->set_htmlText(newText);
            		}
            		else {
HXLINE( 102)			 ::openfl::text::TextField fh = this->_text;
HXDLIN( 102)			fh->set_htmlText((fh->get_htmlText() + (text2 + HX_("<br>",b2,8d,f3,27))));
            		}
HXLINE( 105)		 ::openfl::text::TextField _hx_tmp = this->_text;
HXDLIN( 105)		_hx_tmp->set_scrollV(::Std_obj::_hx_int(( (Float)(this->_text->get_maxScrollV()) )));
...
void Log_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_9fa3e0ab86ae8b4a_110_clear)
HXLINE( 111)		this->_text->set_text(HX_("",00,00,00,00));
HXLINE( 112)		this->_lines->removeRange(0,this->_lines->length);
HXLINE( 114)		this->_text->set_scrollV(0);
            	}
...
void Log_obj::updateSize(){
            	HX_STACKFRAME(&_hx_pos_9fa3e0ab86ae8b4a_122_updateSize)
HXLINE( 123)		this->super::updateSize();
HXLINE( 125)		this->_text->set_width(( (Float)((this->_width - 10)) ));
HXLINE( 126)		this->_text->set_height(( (Float)((this->_height - 15)) ));
            	}
