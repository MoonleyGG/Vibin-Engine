...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1282_drawDebug,"flixel.FlxObject","drawDebug",0x2ad45ea0,"flixel.FlxObject.drawDebug","flixel/FlxObject.hx",1282,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1306_drawDebugOnCamera,"flixel.FlxObject","drawDebugOnCamera",0x0b2ef7e4,"flixel.FlxObject.drawDebugOnCamera","flixel/FlxObject.hx",1306,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1328_drawDebugBoundingBox,"flixel.FlxObject","drawDebugBoundingBox",0xa96b1247,"flixel.FlxObject.drawDebugBoundingBox","flixel/FlxObject.hx",1328,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1335_getDebugBoundingBoxColor,"flixel.FlxObject","getDebugBoundingBoxColor",0xc0f2db08,"flixel.FlxObject.getDebugBoundingBoxColor","flixel/FlxObject.hx",1335,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1350_drawDebugBoundingBoxColor,"flixel.FlxObject","drawDebugBoundingBoxColor",0x00142d9c,"flixel.FlxObject.drawDebugBoundingBoxColor","flixel/FlxObject.hx",1350,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1358_beginDrawDebug,"flixel.FlxObject","beginDrawDebug",0x8677cfb5,"flixel.FlxObject.beginDrawDebug","flixel/FlxObject.hx",1358,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1371_endDrawDebug,"flixel.FlxObject","endDrawDebug",0x2518e603,"flixel.FlxObject.endDrawDebug","flixel/FlxObject.hx",1371,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1439_set_width,"flixel.FlxObject","set_width",0x7d06d55a,"flixel.FlxObject.set_width","flixel/FlxObject.hx",1439,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1453_set_height,"flixel.FlxObject","set_height",0x9f435213,"flixel.FlxObject.set_height","flixel/FlxObject.hx",1453,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1524_set_debugBoundingBoxColorSolid,"flixel.FlxObject","set_debugBoundingBoxColorSolid",0xb8a23688,"flixel.FlxObject.set_debugBoundingBoxColorSolid","flixel/FlxObject.hx",1524,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1530_set_debugBoundingBoxColorNotSolid,"flixel.FlxObject","set_debugBoundingBoxColorNotSolid",0x55ae1bdb,"flixel.FlxObject.set_debugBoundingBoxColorNotSolid","flixel/FlxObject.hx",1530,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1536_set_debugBoundingBoxColorPartial,"flixel.FlxObject","set_debugBoundingBoxColorPartial",0x34746b1e,"flixel.FlxObject.set_debugBoundingBoxColorPartial","flixel/FlxObject.hx",1536,0xf0fe0d80)
...
void FlxObject_obj::drawDebug(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1282_drawDebug)
HXLINE(1283)		if (this->ignoreDrawDebug) {
HXLINE(1284)			return;
            		}
HXLINE(1286)		bool drawPath;
HXDLIN(1286)		if (::hx::IsNotNull( this->path )) {
HXLINE(1286)			drawPath = !(this->path->ignoreDrawDebug);
            		}
            		else {
HXLINE(1286)			drawPath = false;
            		}
HXLINE(1288)		{
HXLINE(1288)			int _g = 0;
HXDLIN(1288)			::Array< ::Dynamic> _g1 = this->getCamerasLegacy();
HXDLIN(1288)			while((_g < _g1->length)){
HXLINE(1288)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(1288)				_g = (_g + 1);
HXLINE(1290)				this->drawDebugOnCamera(camera);
HXLINE(1292)				if (drawPath) {
HXLINE(1294)					this->path->drawDebugOnCamera(camera);
            				}
            			}
            		}
            	}
...
void FlxObject_obj::drawDebugOnCamera( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1306_drawDebugOnCamera)
HXLINE(1307)		bool _hx_tmp;
HXDLIN(1307)		bool _hx_tmp1;
HXDLIN(1307)		if (camera->visible) {
HXLINE(1307)			_hx_tmp1 = !(camera->exists);
            		}
            		else {
HXLINE(1307)			_hx_tmp1 = true;
            		}
HXDLIN(1307)		if (!(_hx_tmp1)) {
HXLINE(1307)			_hx_tmp = !(this->isOnScreen(camera));
            		}
            		else {
...
HXLINE(1310)		 ::flixel::math::FlxRect rect = this->getBoundingBox(camera);
HXLINE(1311)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(1313)			 ::flixel::math::FlxRect view = camera->getViewMarginRect(null());
HXLINE(1314)			{
HXLINE(1314)				view->x = (view->x - ( (Float)(2) ));
HXDLIN(1314)				view->y = (view->y - ( (Float)(2) ));
HXDLIN(1314)				view->width = ((view->width + 2) + 2);
HXDLIN(1314)				view->height = ((view->height + 2) + 2);
            			}
HXLINE(1315)			rect->clipTo(view);
HXLINE(1316)			if (!(view->_inPool)) {
HXLINE(1316)				view->_inPool = true;
HXDLIN(1316)				::flixel::math::FlxRect_obj::_pool->putUnsafe(view);
            			}
            		}
HXLINE(1319)		bool _hx_tmp2;
HXDLIN(1319)		if ((rect->width > 0)) {
HXLINE(1319)			_hx_tmp2 = (rect->height > 0);
            		}
            		else {
HXLINE(1319)			_hx_tmp2 = false;
            		}
HXDLIN(1319)		if (_hx_tmp2) {
HXLINE(1321)			 ::openfl::display::Graphics gfx;
HXDLIN(1321)			if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1321)				::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXDLIN(1321)				gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            			}
            			else {
HXLINE(1321)				gfx = camera->debugLayer->get_graphics();
            			}
HXLINE(1322)			this->drawDebugBoundingBox(gfx,rect,this->allowCollisions,this->immovable);
HXLINE(1323)			if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1323)				camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            			}
            		}
            	}
...
void FlxObject_obj::drawDebugBoundingBox( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int allowCollisions,bool partial){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1328_drawDebugBoundingBox)
HXLINE(1330)		 ::Dynamic color = this->getDebugBoundingBoxColor(allowCollisions);
HXLINE(1331)		this->drawDebugBoundingBoxColor(gfx,rect,( (int)(color) ));
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(FlxObject_obj,drawDebugBoundingBox,(void))
 ...
 ::Dynamic FlxObject_obj::getDebugBoundingBoxColor(int allowCollisions){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1335_getDebugBoundingBoxColor)
HXLINE(1336)		if (::hx::IsNotNull( this->debugBoundingBoxColor )) {
HXLINE(1337)			return this->debugBoundingBoxColor;
            		}
HXLINE(1339)		if ((allowCollisions == 0)) {
HXLINE(1340)			return this->debugBoundingBoxColorNotSolid;
            		}
HXLINE(1342)		if ((allowCollisions == 4369)) {
HXLINE(1343)			return this->debugBoundingBoxColorSolid;
            		}
HXLINE(1345)		return this->debugBoundingBoxColorPartial;
            	}
...
void FlxObject_obj::drawDebugBoundingBoxColor( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1350_drawDebugBoundingBoxColor)
HXLINE(1352)		gfx->lineStyle(1,color,((Float)0.75),false,null(),null(),1,255);
HXLINE(1353)		gfx->drawRect((rect->x + ((Float)0.5)),(rect->y + ((Float)0.5)),(rect->width - ((Float)1.0)),(rect->height - ((Float)1.0)));
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(FlxObject_obj,drawDebugBoundingBoxColor,(void))
 ...
 ::openfl::display::Graphics FlxObject_obj::beginDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1358_beginDrawDebug)
HXDLIN(1358)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1360)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXLINE(1361)			return ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1365)			return camera->debugLayer->get_graphics();
            		}
...
void FlxObject_obj::endDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1371_endDrawDebug)
HXDLIN(1371)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1372)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
Float FlxObject_obj::set_width(Float value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1439_set_width)
HXLINE(1441)		if ((value < 0)) {
HXLINE(1443)			{
HXLINE(1443)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN(1443)				_this->advanced(HX_("An object's width cannot be smaller than 0. Use offset for sprites to control the hitbox position!",f5,8d,0b,95),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/FlxObject.hx",80,0d,fe,f0),1443,HX_("flixel.FlxObject",1f,50,95,35),HX_("set_width",69,fe,5c,f1)));
            			}
HXLINE(1444)			return value;
            		}
HXLINE(1448)		return (this->width = value);
            	}
...
Float FlxObject_obj::set_height(Float value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1453_set_height)
HXLINE(1455)		if ((value < 0)) {
HXLINE(1457)			{
HXLINE(1457)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN(1457)				_this->advanced(HX_("An object's height cannot be smaller than 0. Use offset for sprites to control the hitbox position!",b0,49,90,e4),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/FlxObject.hx",80,0d,fe,f0),1457,HX_("flixel.FlxObject",1f,50,95,35),HX_("set_height",24,16,51,f6)));
            			}
HXLINE(1458)			return value;
            		}
HXLINE(1462)		return (this->height = value);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1524_set_debugBoundingBoxColorSolid)
HXDLIN(1524)		return (this->debugBoundingBoxColorSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorNotSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1530_set_debugBoundingBoxColorNotSolid)
HXDLIN(1530)		return (this->debugBoundingBoxColorNotSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorPartial(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1536_set_debugBoundingBoxColorPartial)
HXDLIN(1536)		return (this->debugBoundingBoxColorPartial = color);
            	}
