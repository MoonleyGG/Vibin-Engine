...
HX_DEFINE_STACK_FRAME(_hx_pos_e1bf2d11aa4bd1bd_9_new,"haxe.MainEvent","new",0x1c640c2b,"haxe.MainEvent.new","D:\\Hackse\\haxe\\std/haxe/MainLoop.hx",9,0x24af7457)
namespace haxe{

void MainEvent_obj::__construct( ::Dynamic f,int p){
            	HX_STACKFRAME(&_hx_pos_e1bf2d11aa4bd1bd_9_new)
