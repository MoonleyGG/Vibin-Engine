...
HX_DEFINE_STACK_FRAME(_hx_pos_0c3fcc0c12b63b54_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","D:\\Hackse\\haxe\\std/haxe/ds/List.hx",266,0x3cb26b2a)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_0c3fcc0c12b63b54_266_new)
