...
HX_DEFINE_STACK_FRAME(_hx_pos_737446d6444861a6_23_new,"haxe.ValueException","new",0xb19045f8,"haxe.ValueException.new","D:\\Hackse\\haxe\\std/haxe/ValueException.hx",23,0x47219416)
namespace haxe{

void ValueException_obj::__construct( ::Dynamic value, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_737446d6444861a6_23_new)
HXDLIN(  23)		{
