...
HX_DEFINE_STACK_FRAME(_hx_pos_959c378d351a4021_28_new,"EReg","new",0x8b859e81,"EReg.new","D:\\Hackse\\haxe\\std/cpp/_std/EReg.hx",28,0x3461bc8f)
HX_LOCAL_STACK_FRAME(_hx_pos_959c378d351a4021_36_match,"EReg","match",0x18fda1a6,"EReg.match","D:\\Hackse\\haxe\\std/cpp/_std/EReg.hx",36,0x3461bc8f)
HX_LOCAL_STACK_FRAME(_hx_pos_959c378d351a4021_45_matched,"EReg","matched",0x8ce62f85,"EReg.matched","D:\\Hackse\\haxe\\std/cpp/_std/EReg.hx",45,0x3461bc8f)
HX_LOCAL_STACK_FRAME(_hx_pos_959c378d351a4021_55_matchedRight,"EReg","matchedRight",0x6157ea17,"EReg.matchedRight","D:\\Hackse\\haxe\\std/cpp/_std/EReg.hx",55,0x3461bc8f)
HX_LOCAL_STACK_FRAME(_hx_pos_959c378d351a4021_62_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","D:\\Hackse\\haxe\\std/cpp/_std/EReg.hx",62,0x3461bc8f)
HX_LOCAL_STACK_FRAME(_hx_pos_959c378d351a4021_65_matchSub,"EReg","matchSub",0xbc75cb7a,"EReg.matchSub","D:\\Hackse\\haxe\\std/cpp/_std/EReg.hx",65,0x3461bc8f)
HX_LOCAL_STACK_FRAME(_hx_pos_959c378d351a4021_74_split,"EReg","split",0x9749433b,"EReg.split","D:\\Hackse\\haxe\\std/cpp/_std/EReg.hx",74,0x3461bc8f)
HX_LOCAL_STACK_FRAME(_hx_pos_959c378d351a4021_98_replace,"EReg","replace",0xae923ad5,"EReg.replace","D:\\Hackse\\haxe\\std/cpp/_std/EReg.hx",98,0x3461bc8f)
...
HX_LOCAL_STACK_FRAME(_hx_pos_959c378d351a4021_149_map,"EReg","map",0x8b84d8bd,"EReg.map","D:\\Hackse\\haxe\\std/cpp/_std/EReg.hx",149,0x3461bc8f)

void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_959c378d351a4021_28_new)
...
bool EReg_obj::match(::String s){
            	HX_STACKFRAME(&_hx_pos_959c378d351a4021_36_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_959c378d351a4021_45_matched)
...
::String EReg_obj::matchedRight(){
            	HX_STACKFRAME(&_hx_pos_959c378d351a4021_55_matchedRight)
...
HX_DEFINE_DYNAMIC_FUNC0(EReg_obj,matchedRight,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_959c378d351a4021_62_matchedPos)
...
bool EReg_obj::matchSub(::String s,int pos,::hx::Null< int >  __o_len){
            	...
            	HX_STACKFRAME(&_hx_pos_959c378d351a4021_65_matchSub)
HXLINE(  66)		int p;
HXDLIN(  66)		if ((len < 0)) {
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACKFRAME(&_hx_pos_959c378d351a4021_74_split)
HXLINE(  75)		int pos = 0;
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_959c378d351a4021_98_replace)
...
::String EReg_obj::map(::String s, ::Dynamic f){
            	HX_GC_STACKFRAME(&_hx_pos_959c378d351a4021_149_map)
