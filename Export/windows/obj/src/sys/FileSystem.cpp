...
HX_LOCAL_STACK_FRAME(_hx_pos_f62ef841c6a19edd_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","D:\\Hackse\\haxe\\std/cpp/_std/sys/FileSystem.hx",31,0x25afe5b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f62ef841c6a19edd_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","D:\\Hackse\\haxe\\std/cpp/_std/sys/FileSystem.hx",38,0x25afe5b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f62ef841c6a19edd_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","D:\\Hackse\\haxe\\std/cpp/_std/sys/FileSystem.hx",75,0x25afe5b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f62ef841c6a19edd_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","D:\\Hackse\\haxe\\std/cpp/_std/sys/FileSystem.hx",78,0x25afe5b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f62ef841c6a19edd_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","D:\\Hackse\\haxe\\std/cpp/_std/sys/FileSystem.hx",93,0x25afe5b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f62ef841c6a19edd_97_deleteDirectory,"sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","D:\\Hackse\\haxe\\std/cpp/_std/sys/FileSystem.hx",97,0x25afe5b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f62ef841c6a19edd_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","D:\\Hackse\\haxe\\std/cpp/_std/sys/FileSystem.hx",101,0x25afe5b1)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_f62ef841c6a19edd_31_exists)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FileSystem_obj,exists,return )
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_f62ef841c6a19edd_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_f62ef841c6a19edd_75_isDirectory)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_f62ef841c6a19edd_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_f62ef841c6a19edd_93_deleteFile)
...
void FileSystem_obj::deleteDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_f62ef841c6a19edd_97_deleteDirectory)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_f62ef841c6a19edd_101_readDirectory)
