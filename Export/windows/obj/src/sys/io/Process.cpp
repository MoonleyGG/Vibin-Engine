...
HX_DEFINE_STACK_FRAME(_hx_pos_fea2e0d8d446ce79_94_new,"sys.io.Process","new",0x849b4c7a,"sys.io.Process.new","D:\\Hackse\\haxe\\std/cpp/_std/sys/io/Process.hx",94,0x88870f56)
HX_LOCAL_STACK_FRAME(_hx_pos_fea2e0d8d446ce79_112_close,"sys.io.Process","close",0x0a954e52,"sys.io.Process.close","D:\\Hackse\\haxe\\std/cpp/_std/sys/io/Process.hx",112,0x88870f56)
namespace sys{
namespace io{

void Process_obj::__construct(::String cmd,::Array< ::String > args, ::Dynamic detached){
            	HX_GC_STACKFRAME(&_hx_pos_fea2e0d8d446ce79_94_new)
...
void Process_obj::close(){
            	HX_STACKFRAME(&_hx_pos_fea2e0d8d446ce79_112_close)
