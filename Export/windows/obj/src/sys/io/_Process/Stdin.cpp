...
HX_DEFINE_STACK_FRAME(_hx_pos_28a6575ed1d07fba_31_new,"sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","D:\\Hackse\\haxe\\std/cpp/_std/sys/io/Process.hx",31,0x88870f56)
HX_LOCAL_STACK_FRAME(_hx_pos_28a6575ed1d07fba_36_close,"sys.io._Process.Stdin","close",0xbd3fe37b,"sys.io._Process.Stdin.close","D:\\Hackse\\haxe\\std/cpp/_std/sys/io/Process.hx",36,0x88870f56)
HX_LOCAL_STACK_FRAME(_hx_pos_28a6575ed1d07fba_41_writeByte,"sys.io._Process.Stdin","writeByte",0xfb987cca,"sys.io._Process.Stdin.writeByte","D:\\Hackse\\haxe\\std/cpp/_std/sys/io/Process.hx",41,0x88870f56)
HX_LOCAL_STACK_FRAME(_hx_pos_28a6575ed1d07fba_47_writeBytes,"sys.io._Process.Stdin","writeBytes",0x29d4b469,"sys.io._Process.Stdin.writeBytes","D:\\Hackse\\haxe\\std/cpp/_std/sys/io/Process.hx",47,0x88870f56)
namespace sys{
namespace io{
namespace _Process{

void Stdin_obj::__construct( ::Dynamic p){
            	HX_STACKFRAME(&_hx_pos_28a6575ed1d07fba_31_new)
HXLINE(  32)		this->p = p;
...
void Stdin_obj::close(){
            	HX_STACKFRAME(&_hx_pos_28a6575ed1d07fba_36_close)
...
void Stdin_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_28a6575ed1d07fba_41_writeByte)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_28a6575ed1d07fba_47_writeBytes)
HXDLIN(  47)		try {
