...
HX_DEFINE_STACK_FRAME(_hx_pos_62052991080b1fed_7_new,"sys.thread.NoEventLoopException","new",0x6e47ae47,"sys.thread.NoEventLoopException.new","D:\\Hackse\\haxe\\std/sys/thread/NoEventLoopException.hx",7,0x6e5d7028)
namespace sys{
namespace thread{
...
void NoEventLoopException_obj::__construct(::String __o_msg, ::haxe::Exception previous){
            	...
            	HX_STACKFRAME(&_hx_pos_62052991080b1fed_7_new)
HXDLIN(   7)		{
