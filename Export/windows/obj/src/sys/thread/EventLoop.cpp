...
HX_DEFINE_STACK_FRAME(_hx_pos_6b9c1951f240389a_24_new,"sys.thread.EventLoop","new",0xafe12fcd,"sys.thread.EventLoop.new","D:\\Hackse\\haxe\\std/sys/thread/EventLoop.hx",24,0xab26ccc4)
HX_LOCAL_STACK_FRAME(_hx_pos_6b9c1951f240389a_146_progress,"sys.thread.EventLoop","progress",0xd3ab8d20,"sys.thread.EventLoop.progress","D:\\Hackse\\haxe\\std/sys/thread/EventLoop.hx",146,0xab26ccc4)
HX_LOCAL_STACK_FRAME(_hx_pos_6b9c1951f240389a_179_loop,"sys.thread.EventLoop","loop",0x33ddc657,"sys.thread.EventLoop.loop","D:\\Hackse\\haxe\\std/sys/thread/EventLoop.hx",179,0xab26ccc4)
namespace sys{
namespace thread{

void EventLoop_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_6b9c1951f240389a_24_new)
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::NextEventTime EventLoop_obj::progress(){
            	HX_STACKFRAME(&_hx_pos_6b9c1951f240389a_146_progress)
...
void EventLoop_obj::loop(){
            	HX_STACKFRAME(&_hx_pos_6b9c1951f240389a_179_loop)
